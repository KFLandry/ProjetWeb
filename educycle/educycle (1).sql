...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 28, 2024 at 09:05 PM
...
--
-- Table structure for table `ed_address`
--
...
--
-- Dumping data for table `ed_address`
--
...
--
-- Table structure for table `ed_comment`
--
...
--
-- Dumping data for table `ed_comment`
--
...
--
-- Table structure for table `ed_donation`
--
...
--
-- Dumping data for table `ed_donation`
--
...
--
-- Table structure for table `ed_item`
--
...
--
-- Dumping data for table `ed_item`
--
...
--
-- Table structure for table `ed_media`
--
...
--
-- Dumping data for table `ed_media`
--
...
--
-- Constraints for table `ed_address`
--
...
--
-- Constraints for table `ed_comment`
--
...
--
-- Constraints for table `ed_donation`
--
