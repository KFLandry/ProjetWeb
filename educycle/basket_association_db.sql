...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 28, 2024 at 09:07 PM
...
--
-- Database: `basket_association_db`
--
...
--
-- Table structure for table `ba_coach`
--
...
--
-- Dumping data for table `ba_coach`
--
...
--
-- Table structure for table `ba_event`
--
...
--
-- Dumping data for table `ba_event`
--
...
--
-- Table structure for table `ba_media`
--
...
--
-- Dumping data for table `ba_media`
--
...
--
-- Table structure for table `ba_middlemediacategory`
--
...
--
-- Table structure for table `ba_middlemediacoach`
--
...
--
-- Dumping data for table `ba_middlemediacoach`
--
...
--
-- Table structure for table `ba_middlemediaplayer`
--
...
--
-- Dumping data for table `ba_middlemediaplayer`
--
...
--
-- Table structure for table `ba_player`
--
...
--
-- Dumping data for table `ba_player`
--
...
--
-- Table structure for table `ba_statistique`
--
...
--
-- Dumping data for table `ba_statistique`
--
...
--
-- Table structure for table `ba_team`
--
...
--
-- Dumping data for table `ba_team`
--
...
--
-- Constraints for table `ba_category`
--
...
--
-- Constraints for table `ba_event`
--
...
--
-- Constraints for table `ba_middlemediacategory`
--
...
--
-- Constraints for table `ba_middlemediacoach`
--
...
--
-- Constraints for table `ba_middlemediaplayer`
--
...
--
-- Constraints for table `ba_player`
--
...
--
-- Constraints for table `ba_statistique`
--
